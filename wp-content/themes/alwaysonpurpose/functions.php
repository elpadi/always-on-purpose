<?php
define('FACEBOOK_URL', 'https://www.facebook.com/amyelizawong');
define('COACHING_PAGE_ID', 8);
/**
...
function twentyten_setup() {
	...
	add_theme_support('custom-header', array('admin-head-callback' => 'twentyten_admin_header_style'));
...
function twentyten_continue_reading_link() {
	return '<div style="text-align:right;"><a href="'. get_permalink() . '">' . __( '<br /><br /><span style="color:#616264;">Continue reading <span class="meta-nav">&rarr;</span></span><br /><br />', 'twentyten' ) . '</a></div>';
}
